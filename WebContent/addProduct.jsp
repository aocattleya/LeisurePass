			...
			<div class="AllBox">
				...
				<s:else>
					<s:form action="AddProductConfirmAction" method="post"
						enctype="multipart/form-data">
				商品ID<br>
						<s:textfield name="productId" placeholder="例：100" class="txt2" />
						<br>
						<br>
				商品名<br>
						<s:textfield name="productName" class="txt2" />
						<br>
						<br>
				商品かな<br>
						<s:textfield name="productNameKana" class="txt2" />
						<br>
						<br>
				商品詳細<br>
						<s:textarea name="productDescription" class="txt2" />
						<br>
						<br>
				カテゴリ<br>
						<select name="categoryId">
				...
				場所<br>
						...
						<br>
				価格(円)<br>
						<s:textfield name="price" class="txt2" />
						<br>
						<br>
				画像ファイル選択<br>
						<s:file name="productImage" />
						...
						<br>
				発売年月<br>
						<s:textfield name="releaseDate" class="txt2" />
						<br>
						<br>
				発売会社<br>
						<s:textfield name="releaseCompany" class="txt2" />
						<br>
						<br>
				所在地<br>
						<s:textfield name="location" class="txt2" />
						<br>
						<br>
				アクセス<br>
						<s:textfield name="access" class="txt2" />
						<br>
						<br>
				URL<br>
						<s:textfield name="url" class="txt2" />
						<br>
						<br>
				開始日<br>
						<s:textfield name="startDate" class="txt2" />
						<br>
						<br>
				終了日<br>
						<s:textfield name="endDate" class="txt2" />
						<br>
						<br>
						<s:submit value="確認画面へ" />
					</s:form>
