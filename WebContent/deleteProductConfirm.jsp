...
<div class="infoBox">
				...
				<div class="info-title">商品詳細</div><br><s:property value="%{#session.deleteProductDTO.productDescription}"  />
					<br>
				<div class="info-title">カテゴリ</div><br><s:if test= "%{#session.deleteProductDTO.categoryId == 2}" >動物園</s:if>
				...
				<br>
				<div class="info-title">場所</div><br><s:if test= "%{#session.deleteProductDTO.placeId == 2}" >茨城県</s:if>
				...
				<br>
				<div class="info-title">価格(円)</div><br><s:property value="%{#session.deleteProductDTO.price}" />
					<br>
				...
				<div class="info-title">開始日</div><br><s:property value="%{#session.deleteProductDTO.startDate}"/>
					<br>
				<div class="info-title">終了日</div><br><s:property value="%{#session.deleteProductDTO.endDate}"/>
					<br>
</div>
			<!-- 商品削除を確定する -->
