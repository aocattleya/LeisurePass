    ...
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        ...
        s = function() {
            ...
            return i(t, [{
                ...
                value: function() {
                    var t = this;
                    this.config.selector && (this.nodes = Array.prototype.slice.call(document.querySelectorAll(this.config.selector))), this.config.selectors && (this.nodes = [], this.config.selectors.forEach(function(n) {
                ...
                value: function(t) {
                    ...
                    this.nodes.forEach(function(t) {
                        e > 0 && e < 1 && t.setAttribute("animated", t.getAttribute("animated") + "|" + n.config.style), n.config.fn({
                            node: t,
