...
( 2, 2, "那須どうぶつ王国","なすどうぶつおうこく","驚きと感動を提供する那須どうぶつ王国では、動物たちによるショーやパフォーマンスを毎日開催、動物本来の能力や知能の高さを間近でご覧いただけます。", 2, 3, 2400,"./images","nasu_animal_kingdom2.jpg",now(),"株式会社那須高原リゾート開発","栃木県那須郡那須町大島1042-1","「那須高原SA」より15分","http://www.nasu-oukoku.com",0,cast('2018-03-01' as date),cast('2018-04-20' as date),now(),now()),
...
( 7, 7, "市川市動植物園","いちかわしどうしょくぶつえん","市川市動植物園は市川市の市立動物園。 1987年8月21日開園。 園内は、レッサーパンダなどを中心とした小動物を飼育している。", 2, 5, 430,"./images","ichikawa_city_zoo.jpg",now(),"市川市","千葉県市川市大町284番１","「市川大野駅」より徒歩10分","http://www.city.ichikawa.lg.jp/zoo/",0,cast('2018-01-01' as date),cast('2018-06-30' as date),now(),now()),
