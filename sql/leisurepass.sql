...
( 2, 2, "那須どうぶつ王国","なすどうぶつおうこく","驚きと感動を提供する那須どうぶつ王国では、動物たちによるショーやパフォーマンスを毎日開催、動物本来の能力や知能の高さを間近でご覧いただけます。", 2, 3, 2400,"./images","nasu_animal_kingdom2.jpg",now(),"株式会社那須高原リゾート開発","栃木県那須郡那須町大島1042-1","「那須高原SA」より15分","http://www.nasu-oukoku.com",0,cast('2018-03-01' as date),cast('2018-04-31' as date),now(),now()),
...
( 7, 7, "市川市動植物園","いちかわしどうしょくぶつえん","市川市動植物園は市川市の市立動物園。 1987年8月21日開園。 園内は、レッサーパンダなどを中心とした小動物を飼育している。", 2, 5, 430,"./images","ichikawa_city_zoo.jpg",now(),"市川市","千葉県市川市大町284番１","「市川大野駅」より徒歩10分","http://www.city.ichikawa.lg.jp/zoo/",0,cast('2018-01-01' as date),cast('2018-06-31' as date),now(),now()),
( 8, 8, "上野動物園","うえのどうぶつえん","上野動物園は、東京の都心部にありながら自然とその景観を維持している都市型の動物園で、約350種2,500点の動物を飼育しています。", 2, 7, 600,"./images","ueno_zoo.jpg",now(),"公益財団法人東京動物園協会","東京都台東区上野公園9-83","「上野駅」より徒歩5分","http://www.tokyo-zoo.net/zoo/ueno/",0,cast('2018-01-01' as date),cast('2018-12-31' as date),now(),now()),
...
( 14, 14, "さいたま水族館","さいたますいぞくかん","さいたま水族館では、86種類の魚が採捕されています。これらのうち、展示可能な約70種類を中心に展示し、その生態や特徴を解説しています。", 3, 6,310,"./images","saitama_aquarium3.jpg",now(),"羽生水郷公園管理事務所","埼玉県羽生市三田ケ谷751-1","「加須駅」よりタクシー15分","http://www.parks.or.jp/suizokukan/",0,cast('2018-03-01' as date),cast('2018-4-31' as date),now(),now()),
...
( 17, 17, "しながわ水族館","しながわすいぞくかん","水族館の飼育員が普段どのような仕事をしているのかを実際に体験できたり、飼育スタッフと一緒に魚のエサの準備をしてエサをあげることもできます。", 3, 7,1350,"./images","shinagawa_aquarium2.jpg",now(),"株式会社サンシャインエンタプライズ","東京都品川区勝島3-2-1","「大森海岸駅」より徒歩8分","http://www.aquarium.gr.jp",0,cast('2018-09-01' as date),cast('2018-9-31' as date),now(),now()),
...
( 36, 36, "サンリオピューロランド","さんりおぴゅーろらんど","ハローキティをはじめ、マイメロディやポムポムプリン、ぼんぼりぼんなど子供から大人まで大人気のサンリオキャラクターたちと触れ合える全天候型屋内テーマパーク。たくさんのキャラクターたちが登場するパレードやアトラクション、キャラクターと遊べるキャラゲーなどサンリオの世界観をたっぷり味わえます。", 5, 7,3800,"./images","sanrio_puroland3.jpg",now(),"株式会社サンリオエンターテイメント","東京都多摩市落合1丁目31","「多摩センター駅」より徒歩5分 ","https://www.puroland.jp/",0,cast('2018-04-01' as date),cast('2018-11-31' as date),now(),now()),
...
( 43, 43, "松山庭園美術館","まつやまていえんびじゅつかん","松山庭園美術館は、田園の中の小高い丘の上にある、瀟洒な美術館です。この美術館は芸術家・此木三紅大のアトリエを公開したもので、氏が参考資料とした数々の名画コレクション、茶道具などを中心に展示しております。", 6, 5,800,"./images","matsuyama_garden_m2.jpg",now(),"公益財団法人花と緑の農芸財団","千葉県匝瑳市松山630","「八日市場駅」より車10分","http://matuyamaartmuseum.web.fc2.com/",0,cast('2018-09-01' as date),cast('2018-09-31' as date),now(),now()),
( 44, 44, "デジタルアートミュージアム","でじたるあーとみゅーじあむ","東京・お台場に、約1万㎡の施設面積をもつ、体験型デジタルアートミュージアムが誕生！5つの世界で構成された巨大空間に、世界初公開作品を含む約50作品が展示されます。不思議な体験をもたらす、5つの世界とは…？", 6, 7,3200,"./images","digital_art_m3jpg.jpg",now(),"森ビル株式会社","東京都江東区青海1-3-8 お台場パレットタウン"," 「東京テレポート駅」より徒歩5分","https://borderless.teamlab.art/jp/",0,cast('2018-04-01' as date),cast('2018-09-31' as date),now(),now()),
